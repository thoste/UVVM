...
quietly set tb_part_path ../../avalon_st
...
do $tb_part_path/script/4_compile_avalon_st_vvc_tb.do  $tb_part_path $vhdl_version
do $tb_part_path/script/5_simulate_avalon_st_vvc_tb.do $tb_part_path $vhdl_version
