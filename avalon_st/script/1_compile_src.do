...
# Set up avalon_st_part_path and lib_name
#------------------------------------------------------
quietly set lib_name "avalon_st"
quietly set part_name "avalon_st"
# path from mpf-file in sim
quietly set avalon_st_part_path "../..//$part_name"

if { [info exists 1] } {
  # path from this part to target part
  quietly set avalon_st_part_path "$1/..//$part_name"
  unset 1
}
...
if {[file exists $avalon_st_part_path/sim/$lib_name]} {
  file delete -force $avalon_st_part_path/sim/$lib_name
}
if {![file exists $avalon_st_part_path/sim]} {
  file mkdir $avalon_st_part_path/sim
}

vlib $avalon_st_part_path/sim/$lib_name
vmap $lib_name $avalon_st_part_path/sim/$lib_name
